...
export default function SeeRecently() {
  ...
  // console.log(addItems[0].sold)
  return (
    <div className="onsaleProduct bg-[#fcc839] py-7">
      <div className="container  py-3 w-[92%] costum-md:w-[90%] costum-2xl:w-[85%]">
  ...
  breakpoints={{
   ...
   <>
     ...
     data-sold={`-${item.sold}%`}
        ...
        <img className="product-imgOne w-[200px] h-[200px] p-2" src={item.mainImg} alt="" />
              <img className="product-imgTwo absolute bg-cover top-0 w-[200px] p-2" src={item.relatedImg[1]} alt="" />
      ...
      <h1 className="product-name  pt-5 h-[70px] overflow-hidden px-2 text-center   ">{item.name}</h1>
        ...
        <button onClick={()=>addToCart(item)}  className="add relative costum-sm:absolute outline-none overflow-hidden bg-[#000]  py-4 w-3/4 text-white rounded-full block mx-auto text-center
